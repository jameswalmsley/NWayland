...
namespace NWayland.Protocols.TextInputUnstableV1
{
    ...
    /// </summary>
    public sealed unsafe partial class ZwpTextInputV1 : NWayland.Protocols.Wayland.WlProxy
    {
        ...
        {
            WlInterface.Init("zwp_text_input_v1", 1, new WlMessage[] {
        ...
        public interface IEvents
        {
            ...
            void OnPreeditString(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, uint @serial, System.String @text, System.String @commit);
            void OnPreeditStyling(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, uint @index, uint @length, uint @style);
            void OnPreeditCursor(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, int @index);
            void OnCommitString(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, uint @serial, System.String @text);
            ...
            void OnLanguage(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, uint @serial, System.String @language);
            void OnTextDirection(NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 eventSender, uint @serial, uint @direction);
        }
        ...
        class ProxyFactory : IBindFactory<ZwpTextInputV1>
        {
            ...
            public ZwpTextInputV1 Create(IntPtr handle, int version, WlDisplay display)
            {
                return new ZwpTextInputV1(handle, version, display);
            }
        }
        ...
        public ZwpTextInputV1(IntPtr handle, int version, NWayland.Protocols.Wayland.WlDisplay display) : base(handle, version, display)
        {
        }
    }
    ...
    /// </summary>
    public sealed unsafe partial class ZwpTextInputManagerV1 : NWayland.Protocols.Wayland.WlProxy
    {
        [System.Runtime.CompilerServices.FixedAddressValueType]
        public static NWayland.Interop.WlInterface WlInterface;
        ...
        {
            WlInterface.Init("zwp_text_input_manager_v1", 1, new WlMessage[] {
                WlMessage.Create("create_text_input", "n", new WlInterface*[] { WlInterface.GeneratorAddressOf(ref NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1.WlInterface) })
            }, new WlMessage[] { });
        }
        ...
        public NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1 CreateTextInput()
        {
            ...
            var __ret = LibWayland.wl_proxy_marshal_array_constructor(this.Handle, 0, __args, ref NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1.WlInterface);
            return __ret == IntPtr.Zero ? null : new NWayland.Protocols.TextInputUnstableV1.ZwpTextInputV1(__ret, Version, Display);
        }
        ...
        class ProxyFactory : IBindFactory<ZwpTextInputManagerV1>
        {
            public WlInterface* GetInterface()
            {
                return WlInterface.GeneratorAddressOf(ref NWayland.Protocols.TextInputUnstableV1.ZwpTextInputManagerV1.WlInterface);
            ...
            public ZwpTextInputManagerV1 Create(IntPtr handle, int version, WlDisplay display)
            {
                return new ZwpTextInputManagerV1(handle, version, display);
            }
        }
        ...
        public ZwpTextInputManagerV1(IntPtr handle, int version, NWayland.Protocols.Wayland.WlDisplay display) : base(handle, version, display)
        {
        }
    }
}